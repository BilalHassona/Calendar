...
public class WeekViewEvent {
     ...
     * @param name Name of the event.
     * @param location The location of the event.
     * @param startOfEvent The time when the event starts.
     * @param endOfEvent The time when the event ends.
     */
    public WeekViewEvent(long id, String name,  String location, Calendar startOfEvent, Calendar endOfEvent) {
        this(id, name, location, startOfEvent, endOfEvent, false);
    }
