package com.example.calendarvariations;
...
import static com.example.calendarvariations.WeekViewUtil.*;
...
public class WeekView extends View {
    ...
    private final GestureDetector.SimpleOnGestureListener mGestureListener = new GestureDetector.SimpleOnGestureListener() {
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
            // Check if current_day view is zoomed.
            if (mIsZooming)
                return true;
...
//            bob.append(utility.getLocation());
//        }
//
//        if (utility.getDescription() != null) {
//            bob.append(utility.getDescription());
//        }
//
//        if (utility.getGuests() != null) {
//            bob.append(utility.getGuests());
//        }
     ...
     * </p>
     * @param length Supported values are {@link com.example.calendarvariations.WeekView#LENGTH_SHORT} and
     * {@link com.example.calendarvariations.WeekView#LENGTH_LONG}.
     */
    @Deprecated
    ...
    public interface EventLongPressListener {
        /**
         * Similar to {@link com.example.calendarvariations.WeekView.EventClickListener} but with a long press.
         * @param event: event clicked.
         * @param eventRect: view containing the clicked event.
         */
    ...
    public interface EmptyViewLongPressListener {
        /**
         * Similar to {@link com.example.calendarvariations.WeekView.EmptyViewClickListener} but with long press.
...
//        @Override
//        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
//            // Check ifcurrent_day view is zoomed.
//            if (mIsZooming)
//                return true;
//
//            switch (mCurrentScrollDirection) {
